...
<-->
    ...
    <li class="nav-item dropdown <?php if($PAGE_ID=='oss') echo 'active'; ?>">
    <a class="nav-link dropdown-toggle dropbtn" data-toggle="dropdown1" href="#" role="button" aria-haspopup="true" aria-expanded="false">Open Source</a>
    <!--  <a class="nav-link" href="/oss.php">GenderMag for Open Source</a>-->
      <div class="dropdown-content dropdown-menu">
        <a class="dropdown-item" href="/oss.php">Research for GenderMag Open Source</a>
        <a class="dropdown-item" href="https://github.com/mendezc1/GenderMagRecordersAssistant/">Recorder's Assistant Tool</a>
        <a class="dropdown-item" href="https://github.com/Amreeta-18/AID">AID Tool</a>
        <!--
        <a class="dropdown-item" href="/research.php">GenderMag Publications</a>-->
      </div>
    </li>    
