...
<div class="red-box persona-input-border">
  <h5>Instructions</h5>
  <ol>
    <li>Update/Change the grey text as desired.</li>
    <li>When finished, click "Print Persona" at the bottom of the page, to produces a printout (or save-as pdf) of your customized persona</li>
  </ol>
</div>
...
<div class="blue-box persona-input-border">
    ...
    <h3>About Your Persona</h3>
     <div class = "col-md-12 row" >
        ...
        <div class="col-md-3 form-group">
             ...
             <div >
                 <label>Age</label>
                 <input class="persona-input form-control form-control-sm" type="text" id="year" value="28 years old" oninput="yearinput()">
              </div>

              <div >
                 <label>Employement</label>
                 <input class="persona-input form-control form-control-sm" type="text" id="emp" value="Employed as an accountant" oninput="empinput()">
              </div>

              <div >
                 <label>Location</label>
                 <input class="persona-input form-control form-control-sm" type="text" id="place" value="Lives in Cardiff, Wales" oninput="placeinput()">
              </div>
   ...
   <form onclick="changeColor('blue');">

            <div >
                <label>Background Information About Abi</label>
                <textarea class="form-control persona-input " rows="6" id="Para1" oninput="paraone()">Abi has always liked music. When she is on her way to work in the morning, she listens to music that spans a wide variety of styles. But when she arrives at work, she turns it off, and begins her day by...</textarea>

                <br/>
                <p class="permanent-text">...scanning all <span id="Pos.adjin1">her</span> emails first to get an overall picture before answering any of them.</p>

                <label>Background Information About Abi</label>
                <textarea class="form-control persona-input " rows="6" id="Para1" oninput="paraone()">(This extra pass takes time but seems worth it.) Some nights she exercises or stretches, and sometimes she likes to play computer puzzle games like Sudoku)</textarea>
...
<form>
<div>
             <label>Background Information and Skills</label>
             <textarea class="form-control persona-input "rows="3"  id="backparaone" oninput="backparaoneip()">Abi works as an accountant. She is comfortable with the technologies she uses regularly, but she just moved to this employer 1 week ago, and...</textarea>

             <br/>
             <p class="permanent-text">Their software systems are new to <span id="obj.pro_inputbox">her</span>. <span id="Nouneop_inputbox">She</span> likes Math and knows how to think with numbers.</p>

             <label>Background Information About Abi</label>
             <textarea class="form-control persona-input " rows="3"  id="backparatwo" oninput="backparatwoip()"> She writes and edits spreadsheet formulas in her work.</textarea>
            <br/>
            <p class="permanent-text">In her free time, </textarea><span id="Nouneopip3"> she </span> also enjoys working with numbers and logic.</p>
            
            <label>Background Information About Abi</label>
            <textarea class="form-control persona-input " rows="3"  id="backparathree" oninput="backparathreeip()"> She especially likes working out puzzles and puzzle games, either on paper or on the computer.</textarea>
...
<hr>
    ...
    <center><button class="btn btn-primary" type="button" onclick="printDiv('printbody')" target="_blank">Print Abi persona</button></center>
</br>
</div>
