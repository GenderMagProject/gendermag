...
if (isset($_GET['persona'])) { 
    ...
    if($personavar=='Dav') { $CURRENT_PERSONA = 'Dav'; } // whitelist
    if($personavar=='Fee') { $CURRENT_PERSONA = 'Fee'; } // whitelist
} ?>
<?php
$data = array(
    'Abi' => array(
        'name' => 'Abi',
        'longname' => 'Abi (Abigail/Abishek) GenderMag Persona',
        'fullname' => 'Abi Jones',
    ...
    'Pat' => array(
        'name' => 'Pat',
        'longname' => 'Pat (Patricia/Patrick) GenderMag Persona',
        'fullname' => 'Patricia',
    ...
    'Tim' => array(
        'name' => 'Tim',
        'longname' => 'Tim (Timothy/Timara) GenderMag Persona',
        'fullname' => 'Timothy',
