...
<div class="col-md-12">
  ...
  <h3>GenderMag Research Publications (from 2016 on)</h3>
...
(<a href="https://www.researchgate.net/publication/339804966_Gender-Inclusive_HCI_Research_and_Design_A_Conceptual_Review">Also available on ResearchGate by request</a>.)</td>
    ...
    <tr>
      <th scope="row">GenderMag Method</th>
      <td>From GenderMag to InclusiveMag: An Inclusive Design Meta-Method</td>
    ...
    <tr>
      ...
      <td>Margaret Burnett, Anita Sarma, Christopher Mendez,
        Alannah Oleson, Claudia Hilderbrand, Zoe Steine-Hanson, Andrew J. Ko</td>
    ...
    <tr>
      ...
      <td>IEEE Symposium on Visual Languages and Human-Centric Computing, October 2017 (to appear)</td>
    </tr>
    <tr>
      <th scope="row">GenderMag Method</th>
...
<div class="tab-pane fade" id="teach" role="tabpanel" aria-labelledby="teach-tab"><br />
  <table class="table">
    ...
    <tr>
      ...
      <td>The GenderMag Teach Project</td>
    ...
    <tr>
      ...
      <td>Alannah Oleson, Christopher Mendez, Zoe Steine-Hanson, Claudia Hilderbrand, Christopher Perdriau, Margaret Burnett and Andrew Ko</td>
...
<div class="tab-pane fade" id="tool" role="tabpanel" aria-labelledby="tool-tab"><br />
  <table class="table">
    ...
    <tr bgcolor="grey"><td /><td /> <td /> <td /></tr> <!-- separator row -->
    <tr>
      <th scope="row">GenderMag Tool</th>
