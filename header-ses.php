...
<html>
  ...
  <head>
    ...
    <title>DRAFT DRAFT DRAFT Socioeconomic Mag</title>
...
<div id="nav" class="header">
  <center>
	...
	<img src="/images/DavMulti.png" alt="The GenderMag Personas" height="200" width="300"align:left>
      </div>



      <div class="col-md-4 col-sm-2" style="align: center; font-family: 'Merriweather', serif;"><h1>Draft Draft Draft Socioeconomic Mag</h1></div>

   

      <div class="col-md-2 col-auto">
	<img src="/images/FeeMulti.png" alt="The GenderMag Personas" height="200" width="300" align:right>
      </div>
